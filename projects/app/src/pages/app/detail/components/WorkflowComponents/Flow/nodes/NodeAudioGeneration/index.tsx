...
import { Box, Input, Button, HStack, Table, Thead, Tbody, Tr, Th, Td } from '@chakra-ui/react';
...
const NodeAudioGeneration = ({ data, selected }: NodeProps<FlowNodeItemType>) => {
...
export default React.memo(NodeAudioGeneration);
